      ...
      <div className="container">
        <div className="center">
          ...
          <p className="gray form-information">
            You can access the tickets you purchased from this page at any time.
            You can download or send your tickets. Please note: You will not be
            able to see tickets for events that have already ended or been
            canceled on this page.
          </p>
...
const canonical = 'https://rotasefestas.com/members/tickets';
