      ...
      <div className="container">
        <div className="center">
          ...
          <p className="gray form-information">
            Please enter your new email address. A verification email including
            your activation code will be sent to your new email address. Your
...
const canonical = 'https://rotasefestas.com/members/email';
